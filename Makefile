# This file contains instructions to build Software ChipSet, a reusable
# component library.  Edit this as needed for your system.
...
$(info BUILDROOT is $(BUILDROOT))

include $(SRCROOT)/common.mk

# Identify the components to build.

COMPONENTS = btree list dupkey readln
